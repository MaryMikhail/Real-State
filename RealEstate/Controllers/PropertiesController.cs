...
namespace RealEstate.Controllers
{
    public class PropertiesController : Controller
    {
        ...
        UserManager<RealEstateUser> userManager;
        SignInManager<RealEstateUser> signInManager;

        public PropertiesController(ApplicationDbContext context, IWebHostEnvironment webHostEnvironment, UserManager<RealEstateUser> userManager, SignInManager<RealEstateUser> signManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            ViewBag.Images = _context.Image.ToList().Where(c => c.PropertyID == id).ToList();
